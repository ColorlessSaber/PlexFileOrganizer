...
def rename_media_folder_and_contents(
        old_media_folder_name: str,
        new_media_folder_name: str,
        dir_path: str,
) -> None:
    """
    ...
    :param old_media_folder_name: The old media folder name with or without edition tag
    :param new_media_folder_name: The new media folder name with or without edition tag
    :param dir_path: The directory path to where the media folder is located.
    :return: None
    """

    media_folder_path = Path("{}/{}".format(dir_path, old_media_folder_name))
    ...
    for files_to_rename in generator_find_media_files:
        for file in files_to_rename:
            ...
            new_file_path = Path(file).with_stem(
                old_file_name.replace(old_media_folder_name, new_media_folder_name)
    ...
    media_folder_path.rename("{}/{}".format(dir_path, new_media_folder_name))
