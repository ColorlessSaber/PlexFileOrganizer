    ...
    def run(self) -> None:
        ...
        try:
            ...
            if self.media_folder_information.check_if_media_folder_exists():
                ...
                self.signals.progress.emit(18, 'Folder does not exist. Starting the process of creating Media Folder for: ' +
                ...
                if self.media_folder_information.media_type.is_tv():
                    ...
                    if self.media_folder_information.specials_season:
                        self.signals.progress.emit(63, "-- Generating Specials season folder.")
                        ...
                        self.signals.progress.emit(72, "-- Specials season folder generated.")
                    else:
                        self.signals.progress.emit(72, "-- Skipping Specials season folder generation.")
                else:
                    self.signals.progress.emit(72, "-- Media folder is for movie; no seasons and/or Specials season folder will be generated.")
                ...
                if self.media_folder_information.check_if_new_extra_folders_are_needed():
                    ...
                    self.signals.progress.emit(90, '-- No extra folder(s) needed to be created.')
