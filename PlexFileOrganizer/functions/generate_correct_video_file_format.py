...
def generate_correct_video_file_format(list_of_video_files: tuple[str])\
    ...
    if folder_and_files_patterns.tv_show_season_folder_check(first_file_in_list.folder_file_is_in()):
        ...
        for file in class_based_video_file_list:
            if folder_and_files_patterns.extra_media_file_check(file.file_name(), file.folder_file_is_in()):
                file_number = folder_and_files_patterns.extra_file_format_regex_pattern.match(file.file_name()).group('number')
