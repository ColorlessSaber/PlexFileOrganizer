...
class CorrectMediaFileFormat:
    ...
    def movie_format(self, media_file):
        ...
        movie_format = re.compile(r"""
                    ...
                    """, re.VERBOSE | re.IGNORECASE)
        if movie_format.match(media_file.name).group('title') == media_file.path('/')[-1]:
            return True
        else:
            return False
    ...
    def trailer_format(self, media_file):
        ...
        trailer_folder_format = re.compile(r"""
            ...
            .\w+    # file extension
            """, re.VERBOSE | re.IGNORECASE)
        if re.match(r"trailer", media_file.path.split('/')[-1], re.IGNORECASE):
    ...
    def behind_the_scenes_format(self, media_file):
        ...
        behind_the_scenes_format = re.compile(r"""
            ...
            .\w+    # file extension
            """, re.VERBOSE | re.IGNORECASE)
        if re.match(r"behind the scenes", media_file.path.split('/')[-1], re.IGNORECASE):
    ...
    def deleted_scenes_format(self, media_file):
        ...
        deleted_scenes_format = re.compile(r"""
                ...
                .\w+    # file extension
                """, re.VERBOSE | re.IGNORECASE)
        if re.match(r"deleted scenes", media_file.path.split('/')[-1], re.IGNORECASE):
    ...
    def featurettes_format(self, media_file):
        ...
        featurettes_format = re.compile(r"""
                    ...
                    .\w+    # file extension
                    """, re.VERBOSE | re.IGNORECASE)
        if re.match(r"featurettes", media_file.path.split('/')[-1], re.IGNORECASE):
    ...
    def interviews_format(self, media_file):
        ...
        interviews_format = re.compile(r"""
                        ...
                        .\w+    # file extension
                        """, re.VERBOSE | re.IGNORECASE)
        if re.match(r"interviews", media_file.path.split('/')[-1], re.IGNORECASE):
    ...
    def scenes_format(self, media_file):
        ...
        scenes_format = re.compile(r"""
                            ...
                            .\w+    # file extension
                            """, re.VERBOSE | re.IGNORECASE)
        if re.match(r"scenes", media_file.path.split('/')[-1], re.IGNORECASE):
    ...
    def shorts_format(self, media_file):
        ...
        shorts_format = re.compile(r"""
                    ...
                    .\w+    # file extension
                    """, re.VERBOSE | re.IGNORECASE)
        if re.match(r"shorts", media_file.path.split('/')[-1], re.IGNORECASE):
    ...
    def other_format(self, media_file):
        ...
        if re.match(r"other", media_file.path.split('/')[-1], re.IGNORECASE):
