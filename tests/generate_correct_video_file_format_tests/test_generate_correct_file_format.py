...
class TestGenerateCorrectFileFormat:
    def test_generate_correct_file_format_for_tv_show(self):
        files_to_update = (
    ...
    def test_generate_correct_file_format_for_extras(self):
        files_to_update = (
    ...
    def test_generate_correct_file_format_for_movie(self):
