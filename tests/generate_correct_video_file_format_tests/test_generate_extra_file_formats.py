...
class TestExtraFileFormats:
    def test_extra_file_trailer_format(self):
        ...
        if result[0][1] != "/dir/dir1/Zenless Zone Zero/Trailers/Trailer 3.txt":
            assert False, (
                f"Extra file for trailer folder is not formated correctly. {result[0][1]}"
            )
    ...
    def test_extra_file_behind_scenes_format(self):
        ...
        if (
            result[0][1]
            != "/dir/dir1/Zenless Zone Zero/Behind the Scenes/Behind the Scene 3.txt"
        ):
            assert False, (
                f"Extra file for Behind the Scenes folder is not formated correctly. {result[0][1]}"
            )
    ...
    def test_extra_file_deleted_scenes_format(self):
        ...
        if (
            result[0][1]
            != "/dir/dir1/Zenless Zone Zero/Deleted Scenes/Deleted Scene 3.txt"
        ):
            assert False, (
                f"Extra file for Deleted Scenes folder is not formated correctly. {result[0][1]}"
            )
    ...
    def test_extra_file_featurettes_format(self):
        ...
        if result[0][1] != "/dir/dir1/Zenless Zone Zero/Featurettes/Featurette 3.txt":
            assert False, (
                f"Extra file for Featurettes folder is not formated correctly. {result[0][1]}"
            )
    ...
    def test_extra_file_interviews_format(self):
        ...
        if result[0][1] != "/dir/dir1/Zenless Zone Zero/Interviews/Interview 3.txt":
            assert False, (
                f"Extra file for Interviews folder is not formated correctly. {result[0][1]}"
            )
    ...
    def test_extra_file_scenes_format(self):
        ...
        if result[0][1] != "/dir/dir1/Zenless Zone Zero/Scenes/Scene 3.txt":
            assert False, (
                f"Extra file for Scenes folder is not formated correctly. {result[0][1]}"
            )
    ...
    def test_extra_file_other_format(self):
        ...
        if result[0][1] != "/dir/dir1/Zenless Zone Zero/Other/Other 3.txt":
            assert False, (
                f"Extra file for Others folder is not formated correctly. {result[0][1]}"
            )
