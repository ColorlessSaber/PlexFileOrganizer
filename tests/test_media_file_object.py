...
class TestMediaFileObject:
    def test_file_name_with_extension(self):
        ...
        assert file.file_name() == "Zenless Zone Zero - s01e01.txt", (
            "Failed to return just file with extension."
        )
    ...
    def test_file_name_without_extension(self):
        ...
        assert file.file_name(with_extension=False) == "Zenless Zone Zero - s01e01", (
            "Failed to return just file with extension."
        )
    ...
    def test_folder_file_is_in(self):
        ...
        assert file.folder_file_is_in() == "Season 1", (
            "Failed to return just folder with extension."
        )
